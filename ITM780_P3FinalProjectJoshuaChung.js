...
function Formvalidation() { // Validates the users submision
  var validate = validateForm();
  if (validate == true) {
    alert("Success, your form has been submitted, thank you! I will get back to you in 1-5 business days."); //Prompts user their submission was able to sent
  } else {
    alert("Error, your form was unable to send. Please try again later."); //Prompts user their submision was unable to send
  }
  return validate;
}
